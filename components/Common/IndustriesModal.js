...
const ServicesModal = ({
    ...
    const modalBodyMaker = () => {
        switch (modalHeader) {
            case "Material Treatments": return (
                <>
                    ...
                    <ul>
                        ...
                        <li>Mechanical Treatment of components such as turning and tapering.</li>
                    </ul>
            ...
            case "Logistics": return (
                <>
                    ...
                    <p>Thanks to our efficient stock management for which we use the most advanced software available, we are able to reduce our total costs. This makes us able to control our prices.</p>
                </>)

                break;
            case "Consultancy & Customer Dedicated": return (
                <>
                    <h2>Project management</h2>
                    <p>Based on our knowledge and over 40 years of experience, we are able to handle the entire material management on complex construction projects from concept to execution phase.</p>
                </>)
            ...
            case "Document Management": return (
                <>
                    ...
                    <p>We provide complete technical documentation and data dossiers in the contractual language to complete the supply. Documentation supplied, depending on client request, may consist of:</p>
                    <ul>
                        ...
                        <li>NDT Reports</li>
                        <li>Material Test Certificate to DIN 50049 or EN 10204 type 2.1, 2.2, 2.3, 3.1, 3.2, (3.1b, 3.1c) according to client requirements. Each QC dossier is supplied with the number of copies stipulated in the contract.
                        </li>
                    </ul>
                </>)
    ...
    return (
        ...
        >
            <Modal.Header closeButton>
                <Modal.Title><h1> {modalHeader} </h1></Modal.Title>
            </Modal.Header>
            <Modal.Body>
                {modalBodyMaker()}
            </Modal.Body>
