        ...
        <>
            ...
            <div className="main-text-area ptb-80">
                <div className="container">
                    ...
                    <p>Welcome to United Piping Solutions - Piping The World!</p>

                    <p>
                        These terms and conditions outline the rules and regulations for the
                        use of United Piping Solutions LLC's Website, located at
                        https://www.unitedpipinggroup.com.
                    </p>

                    <p>
                        By accessing this website we assume you accept these terms and
                        conditions. Do not continue to use United Piping Solutions - Piping
                        The World if you do not agree to take all of the terms and
                    ...
                    <p>
                        We employ the use of cookies. By accessing United Piping Solutions -
                        Piping The World, you agreed to use cookies in agreement with the
                        United Piping Solutions LLC's Privacy Policy.{" "}
                    </p>
                    ...
                    <p>
                        Unless otherwise stated, United Piping Solutions LLC and/or its
                        licensors own the intellectual property rights for all material on
                        United Piping Solutions - Piping The World. All intellectual
                    ...
                    <ul>
                        <li>
                            Republish material from United Piping Solutions - Piping The World
                        </li>
                        <li>
                            Sell, rent or sub-license material from United Piping Solutions -
                            Piping The World
                        </li>
                        <li>
                            Reproduce, duplicate or copy material from United Piping Solutions
                            - Piping The World
                        </li>
                        <li>
                            Redistribute content from United Piping Solutions - Piping The
                            World
                        </li>
                    </ul>
                    ...
                    <p>
                        ...
                        United Piping Solutions LLC does not filter, edit, publish or review
                        Comments prior to their presence on the website. Comments do not
                        reflect the views and opinions of United Piping Solutions LLC,its
                        ...
                        permitted by applicable laws, United Piping Solutions LLC shall not
                    ...
                    <p>
                        United Piping Solutions LLC reserves the right to monitor all
                    ...
                    <p>
                        You hereby grant United Piping Solutions LLC a non-exclusive license
                    ...
                    <p>
                        ...
                        sending an e-mail to United Piping Solutions LLC. Please include
                    ...
                    <p>
                        No use of United Piping Solutions LLC's logo or other artwork will
