		...
		<>
			...
			<div className="main-text-area ptb-80">
				<div className="container">
					...
					<p>Welcome to United International Piping - Piping The World!</p>
					...
					<p>
						...
						conditions. Do not continue to use United International Piping -
						Piping The World if you do not agree to take all of the terms and
					...
					<ul>
						<li>
							Republish material from United International Piping - Piping The
							World
						</li>
						<li>
							Sell, rent or sub-license material from United International
							Piping - Piping The World
						</li>
						<li>
							Reproduce, duplicate or copy material from United International
							Piping - Piping The World
						</li>
						<li>
							Redistribute content from United International Piping - Piping The
							World
						</li>
					</ul>
