			...
			<div className="main-text-area ptb-80">
				<div className="container">
					...
					<p>
						...
						that they shared and/or collect in United International Piping -
						Piping The World. This policy is not applicable to any information
					...
					<p>
						United International Piping - Piping The World follows a standard
					...
					<p>
						Like any other website, United International Piping - Piping The
						World uses 'cookies'. These cookies are used to store information
					...
					<p>
						...
						advertising partners of United International Piping - Piping The
						World.
					</p>
					...
					<p>
						Note that United International Piping - Piping The World has no
					...
					<p>
						United International Piping - Piping The World's Privacy Policy does
					...
					<p>
						United International Piping - Piping The World does not knowingly
