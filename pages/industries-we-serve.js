                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 services-details">
                            <div className="services-details-desc">
                                ...
                                <p className="text-justify">
                                    ...
                                    makes uPS your ideal Partner. our experts have a wealth of
                        ...
                        <div className="col-lg-6 services-details-image">
                            <img
                                ...
                                alt="Downstream and Midstream Industries - United Piping Solutions"
                            />
                        </div>
                    </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 services-details-image">
                            <img
                                ...
                                width="100%"
                                className="animate__animated animate__fadeInUp"
                                alt="Upstream and Offshore Industries - United Piping Solutions"
                            />
                        </div>
                        ...
                        <div className="col-lg-6 services-details">
                            <div className="services-details-desc">
                                ...
                                <p className="text-justify">
                                    UPS provides its customers, with technical advice and high
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 services-details">
                            <div className="services-details-desc">
                                ...
                                <p className="text-justify">
                                    UPS has extensive experience in all differ- ent power
                                    segments. From Hydro power up to the biggest CCPP and lignite
                                    Fired Power stations, uPS is able to support its customers in
                        ...
                        <div className="col-lg-6 services-details-image">
                            <img
                                ...
                                width="100%"
                                className="animate__animated animate__fadeInUp"
                                alt="Power Generation & Renewable Energy - United Piping Solutions"
                            />
                        </div>
                    </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 services-details-image">
                            <img
                                ...
                                width="100%"
                                className="animate__animated animate__fadeInUp"
                                alt="Infrastructure, Building and Water Industry - United Piping Solutions"
                            />
                        </div>
                        ...
                        <div className="col-lg-6 services-details">
                            <div className="services-details-desc">
                                ...
                                <p className="text-justify">
                                    ...
                                    materials. uPS has a strong position in this segment as well,
